...
export function TabsDemo() {
  const tabs = [
    {
      ...
      value: "product",
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl text-xl md:text-4xl font-bold text-white bg-neutral-900">
          <p>Product Tab</p>
          <DummyContenttabs />
        </div>
      ),
  ...
  return (
    <div className="h-[30rem] md:h-[50rem] [perspective:1000px] relative flex flex-col max-w-7xl mx-auto w-full  items-start justify-start my-40">
     <div>
     <h2 className="max-w-7xl pl-2 mx-auto text-xl md:text-5xl font-bold text-white font-sans mb-5">
