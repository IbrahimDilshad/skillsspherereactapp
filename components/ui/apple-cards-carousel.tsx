  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            >
              <button
                className="sticky top-4 h-8 w-8 right-0 ml-auto bg-neutral-800 rounded-full flex items-center justify-center"
                onClick={handleClose}
              >
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="rounded-3xl bg-neutral-900 h-80 w-56 md:h-[30rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10"
      >
